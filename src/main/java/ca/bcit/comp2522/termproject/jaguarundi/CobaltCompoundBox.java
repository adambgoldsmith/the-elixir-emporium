...
public class CobaltCompoundBox extends IngredientBox{
    public final static Image COBALT_COMPOUND_BOX_SPRITE = new Image(Objects.requireNonNull(CobaltCompound.class.getResourceAsStream("cobalt_compound_crate.png")));
